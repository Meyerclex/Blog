(() => {
  ...
  $jscomp.arrayIteratorImpl = function(b) {
    var a = 0;
    return function() {
      return a < b.length ? { done: false, value: b[a++] } : { done: true };
    };
  };
    ...
    window.ViewImage = new function() {
      ...
      this.init = function(a) {
        ...
        ["removeEventListener", "addEventListener"].forEach(function(d) {
          document[d]("click", b.listener, false);
        });
      };
      this.display = function(a, d) {
        var c = a.indexOf(d), e = new DOMParser().parseFromString(
          ...
          "text/html"
        ).body.firstChild, g = function(f) {
          var h = { Escape: "close", ArrowLeft: "tools__flip-prev", ArrowRight: "tools__flip-next" };
          h[f.key] && e.querySelector(".view-image-" + h[f.key]).click();
        }, l = function(f) {
          var h = new Image(), k = e.querySelector(".view-image-lead");
