...
3. 我在`<head>`里放了太多外部字体了，这个是最主要的问题。实际上我全站只用了3个中文字体2个英文字体吧，把多余的中文字体删掉了。而且汇文那个系列的字体文件超级巨大，我本来是下载的资源发现压缩后还有8M多轻轻破碎了，我只有英文导航栏用了一下，决定删掉改用外部字体了。

处理完之后从2.8秒左右的加载速度恢复到了400ms，可喜可贺！
