...
虽然我换了首页样式，但还是保留了原来的首页，因此可以查看 **[Demo](https://5d4f9183.hugo-newspaper.pages.dev/)** 来玩一玩。萌吧？（笑）
...
1. 更新了一个气泡样式的Status Cafe状态，窃取了动森对话气泡的颜色：[Codepen - Bubble](https://codepen.io/meyerclex/pen/Pwqoxqp)。
2. 为防止我经常性更改CSS导致样式失效，所以也把本篇的样式上传到了：[Codepen - Status Cafe List](https://codepen.io/meyerclex/pen/gbpOQPg)
